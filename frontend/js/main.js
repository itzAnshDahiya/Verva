...
function updateHeaderWithUser() {
  ...
  if (user && avatarBtn) {
    // User is logged in - show avatar, hide auth buttons
    ...
    // User not logged in - show auth buttons, hide avatar
...
window.addEventListener('load', updateHeaderWithUser);
document.addEventListener('VERVA:authchanged', updateHeaderWithUser);
